# 77. Quarterly Tax Report Module — Full Module Specification

## Main Purpose
The **Quarterly Tax Report Module** is responsible for quarterly tax pack for owner/accountant in **Tradie Job Manager**.
...
```txt
GET    /api/quarterly_tax_report_module
POST   /api/quarterly_tax_report_module
GET    /api/quarterly_tax_report_module/:id
PATCH  /api/quarterly_tax_report_module/:id
DELETE /api/quarterly_tax_report_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/quarterly_tax_report_module
```
...
```txt
QUARTERLY_TAX_REPORT_MODULE_VIEWED
QUARTERLY_TAX_REPORT_MODULE_CREATED
QUARTERLY_TAX_REPORT_MODULE_UPDATED
QUARTERLY_TAX_REPORT_MODULE_DELETED
QUARTERLY_TAX_REPORT_MODULE_ACCESS_DENIED
QUARTERLY_TAX_REPORT_MODULE_EXPORTED
```
