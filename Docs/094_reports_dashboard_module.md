# 94. Reports Dashboard Module — Full Module Specification

## Main Purpose
The **Reports Dashboard Module** is responsible for central report hub and report summaries in **Tradie Job Manager**.
...
```txt
GET    /api/reports_dashboard_module
POST   /api/reports_dashboard_module
GET    /api/reports_dashboard_module/:id
PATCH  /api/reports_dashboard_module/:id
DELETE /api/reports_dashboard_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/reports_dashboard_module
```
...
```txt
REPORTS_DASHBOARD_MODULE_VIEWED
REPORTS_DASHBOARD_MODULE_CREATED
REPORTS_DASHBOARD_MODULE_UPDATED
REPORTS_DASHBOARD_MODULE_DELETED
REPORTS_DASHBOARD_MODULE_ACCESS_DENIED
REPORTS_DASHBOARD_MODULE_EXPORTED
```
