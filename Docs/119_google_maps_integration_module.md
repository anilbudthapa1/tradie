# 119. Google Maps Integration Module — Full Module Specification

## Main Purpose
The **Google Maps Integration Module** is responsible for addresses, distance and route planning in **Tradie Job Manager**.
...
```txt
GET    /api/google_maps_integration_module
POST   /api/google_maps_integration_module
GET    /api/google_maps_integration_module/:id
PATCH  /api/google_maps_integration_module/:id
DELETE /api/google_maps_integration_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/google_maps_integration_module
```
...
```txt
GOOGLE_MAPS_INTEGRATION_MODULE_VIEWED
GOOGLE_MAPS_INTEGRATION_MODULE_CREATED
GOOGLE_MAPS_INTEGRATION_MODULE_UPDATED
GOOGLE_MAPS_INTEGRATION_MODULE_DELETED
GOOGLE_MAPS_INTEGRATION_MODULE_ACCESS_DENIED
GOOGLE_MAPS_INTEGRATION_MODULE_EXPORTED
```
