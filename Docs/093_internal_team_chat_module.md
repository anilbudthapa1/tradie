# 93. Internal Team Chat Module — Full Module Specification

## Main Purpose
The **Internal Team Chat Module** is responsible for job/business internal chat later in **Tradie Job Manager**.
...
```txt
GET    /api/internal_team_chat_module
POST   /api/internal_team_chat_module
GET    /api/internal_team_chat_module/:id
PATCH  /api/internal_team_chat_module/:id
DELETE /api/internal_team_chat_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/internal_team_chat_module
```
...
```txt
INTERNAL_TEAM_CHAT_MODULE_VIEWED
INTERNAL_TEAM_CHAT_MODULE_CREATED
INTERNAL_TEAM_CHAT_MODULE_UPDATED
INTERNAL_TEAM_CHAT_MODULE_DELETED
INTERNAL_TEAM_CHAT_MODULE_ACCESS_DENIED
INTERNAL_TEAM_CHAT_MODULE_EXPORTED
```
