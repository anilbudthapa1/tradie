# 15. Customer Management Module — Full Module Specification

## Main Purpose
The **Customer Management Module** is responsible for customer CRUD, customer profile and customer lifecycle in **Tradie Job Manager**.
...
```txt
GET    /api/customer_management_module
POST   /api/customer_management_module
GET    /api/customer_management_module/:id
PATCH  /api/customer_management_module/:id
DELETE /api/customer_management_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/customer_management_module
```
...
```txt
CUSTOMER_MANAGEMENT_MODULE_VIEWED
CUSTOMER_MANAGEMENT_MODULE_CREATED
CUSTOMER_MANAGEMENT_MODULE_UPDATED
CUSTOMER_MANAGEMENT_MODULE_DELETED
CUSTOMER_MANAGEMENT_MODULE_ACCESS_DENIED
CUSTOMER_MANAGEMENT_MODULE_EXPORTED
```
