# 128. Franchise Multi Branch Module — Full Module Specification

## Main Purpose
The **Franchise Multi Branch Module** is responsible for multi-branch/franchise hierarchy later in **Tradie Job Manager**.
...
```txt
GET    /api/franchise_multi_branch_module
POST   /api/franchise_multi_branch_module
GET    /api/franchise_multi_branch_module/:id
PATCH  /api/franchise_multi_branch_module/:id
DELETE /api/franchise_multi_branch_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/franchise_multi_branch_module
```
...
```txt
FRANCHISE_MULTI_BRANCH_MODULE_VIEWED
FRANCHISE_MULTI_BRANCH_MODULE_CREATED
FRANCHISE_MULTI_BRANCH_MODULE_UPDATED
FRANCHISE_MULTI_BRANCH_MODULE_DELETED
FRANCHISE_MULTI_BRANCH_MODULE_ACCESS_DENIED
FRANCHISE_MULTI_BRANCH_MODULE_EXPORTED
```
