# 30. Superannuation Tracking Module — Full Module Specification

## Main Purpose
The **Superannuation Tracking Module** is responsible for super settings, super summaries and contribution tracking in **Tradie Job Manager**.
...
```txt
GET    /api/superannuation_tracking_module
POST   /api/superannuation_tracking_module
GET    /api/superannuation_tracking_module/:id
PATCH  /api/superannuation_tracking_module/:id
DELETE /api/superannuation_tracking_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/superannuation_tracking_module
```
...
```txt
SUPERANNUATION_TRACKING_MODULE_VIEWED
SUPERANNUATION_TRACKING_MODULE_CREATED
SUPERANNUATION_TRACKING_MODULE_UPDATED
SUPERANNUATION_TRACKING_MODULE_DELETED
SUPERANNUATION_TRACKING_MODULE_ACCESS_DENIED
SUPERANNUATION_TRACKING_MODULE_EXPORTED
```
