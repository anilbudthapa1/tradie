# 58. Materials Cost Calculator Module — Full Module Specification

## Main Purpose
The **Materials Cost Calculator Module** is responsible for calculate material costs and markup in **Tradie Job Manager**.
...
```txt
GET    /api/materials_cost_calculator_module
POST   /api/materials_cost_calculator_module
GET    /api/materials_cost_calculator_module/:id
PATCH  /api/materials_cost_calculator_module/:id
DELETE /api/materials_cost_calculator_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/materials_cost_calculator_module
```
...
```txt
MATERIALS_COST_CALCULATOR_MODULE_VIEWED
MATERIALS_COST_CALCULATOR_MODULE_CREATED
MATERIALS_COST_CALCULATOR_MODULE_UPDATED
MATERIALS_COST_CALCULATOR_MODULE_DELETED
MATERIALS_COST_CALCULATOR_MODULE_ACCESS_DENIED
MATERIALS_COST_CALCULATOR_MODULE_EXPORTED
```
