# 88. Email Notification Module — Full Module Specification

## Main Purpose
The **Email Notification Module** is responsible for send system emails and templates in **Tradie Job Manager**.
...
```txt
GET    /api/email_notification_module
POST   /api/email_notification_module
GET    /api/email_notification_module/:id
PATCH  /api/email_notification_module/:id
DELETE /api/email_notification_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/email_notification_module
```
...
```txt
EMAIL_NOTIFICATION_MODULE_VIEWED
EMAIL_NOTIFICATION_MODULE_CREATED
EMAIL_NOTIFICATION_MODULE_UPDATED
EMAIL_NOTIFICATION_MODULE_DELETED
EMAIL_NOTIFICATION_MODULE_ACCESS_DENIED
EMAIL_NOTIFICATION_MODULE_EXPORTED
```
