# 57. Labour Cost Calculator Module — Full Module Specification

## Main Purpose
The **Labour Cost Calculator Module** is responsible for calculate labour cost by hourly rate/hours in **Tradie Job Manager**.
...
```txt
GET    /api/labour_cost_calculator_module
POST   /api/labour_cost_calculator_module
GET    /api/labour_cost_calculator_module/:id
PATCH  /api/labour_cost_calculator_module/:id
DELETE /api/labour_cost_calculator_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/labour_cost_calculator_module
```
...
```txt
LABOUR_COST_CALCULATOR_MODULE_VIEWED
LABOUR_COST_CALCULATOR_MODULE_CREATED
LABOUR_COST_CALCULATOR_MODULE_UPDATED
LABOUR_COST_CALCULATOR_MODULE_DELETED
LABOUR_COST_CALCULATOR_MODULE_ACCESS_DENIED
LABOUR_COST_CALCULATOR_MODULE_EXPORTED
```
