# 45. Drag And Drop Scheduler Module — Full Module Specification

## Main Purpose
The **Drag And Drop Scheduler Module** is responsible for interactive scheduling with conflict checks in **Tradie Job Manager**.
...
```txt
GET    /api/drag_and_drop_scheduler_module
POST   /api/drag_and_drop_scheduler_module
GET    /api/drag_and_drop_scheduler_module/:id
PATCH  /api/drag_and_drop_scheduler_module/:id
DELETE /api/drag_and_drop_scheduler_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/drag_and_drop_scheduler_module
```
...
```txt
DRAG_AND_DROP_SCHEDULER_MODULE_VIEWED
DRAG_AND_DROP_SCHEDULER_MODULE_CREATED
DRAG_AND_DROP_SCHEDULER_MODULE_UPDATED
DRAG_AND_DROP_SCHEDULER_MODULE_DELETED
DRAG_AND_DROP_SCHEDULER_MODULE_ACCESS_DENIED
DRAG_AND_DROP_SCHEDULER_MODULE_EXPORTED
```
