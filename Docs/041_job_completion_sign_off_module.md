# 41. Job Completion Sign-Off Module — Full Module Specification

## Main Purpose
The **Job Completion Sign-Off Module** is responsible for customer/worker sign-off, proof and completion checklist in **Tradie Job Manager**.
...
```txt
GET    /api/job_completion_sign_off_module
POST   /api/job_completion_sign_off_module
GET    /api/job_completion_sign_off_module/:id
PATCH  /api/job_completion_sign_off_module/:id
DELETE /api/job_completion_sign_off_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/job_completion_sign_off_module
```
...
```txt
JOB_COMPLETION_SIGN_OFF_MODULE_VIEWED
JOB_COMPLETION_SIGN_OFF_MODULE_CREATED
JOB_COMPLETION_SIGN_OFF_MODULE_UPDATED
JOB_COMPLETION_SIGN_OFF_MODULE_DELETED
JOB_COMPLETION_SIGN_OFF_MODULE_ACCESS_DENIED
JOB_COMPLETION_SIGN_OFF_MODULE_EXPORTED
```
