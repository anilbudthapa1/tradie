# 50. Distance Calculator Module — Full Module Specification

## Main Purpose
The **Distance Calculator Module** is responsible for calculate distance/time between jobs and base in **Tradie Job Manager**.
...
```txt
GET    /api/distance_calculator_module
POST   /api/distance_calculator_module
GET    /api/distance_calculator_module/:id
PATCH  /api/distance_calculator_module/:id
DELETE /api/distance_calculator_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/distance_calculator_module
```
...
```txt
DISTANCE_CALCULATOR_MODULE_VIEWED
DISTANCE_CALCULATOR_MODULE_CREATED
DISTANCE_CALCULATOR_MODULE_UPDATED
DISTANCE_CALCULATOR_MODULE_DELETED
DISTANCE_CALCULATOR_MODULE_ACCESS_DENIED
DISTANCE_CALCULATOR_MODULE_EXPORTED
```
