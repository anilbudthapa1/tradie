# 86. Compliance Expiry Reminder Module — Full Module Specification

## Main Purpose
The **Compliance Expiry Reminder Module** is responsible for licence, insurance and certification expiry reminders in **Tradie Job Manager**.
...
```txt
GET    /api/compliance_expiry_reminder_module
POST   /api/compliance_expiry_reminder_module
GET    /api/compliance_expiry_reminder_module/:id
PATCH  /api/compliance_expiry_reminder_module/:id
DELETE /api/compliance_expiry_reminder_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/compliance_expiry_reminder_module
```
...
```txt
COMPLIANCE_EXPIRY_REMINDER_MODULE_VIEWED
COMPLIANCE_EXPIRY_REMINDER_MODULE_CREATED
COMPLIANCE_EXPIRY_REMINDER_MODULE_UPDATED
COMPLIANCE_EXPIRY_REMINDER_MODULE_DELETED
COMPLIANCE_EXPIRY_REMINDER_MODULE_ACCESS_DENIED
COMPLIANCE_EXPIRY_REMINDER_MODULE_EXPORTED
```
