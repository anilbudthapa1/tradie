# 62. Quote To Job Conversion Module — Full Module Specification

## Main Purpose
The **Quote To Job Conversion Module** is responsible for convert accepted quote into scheduled job in **Tradie Job Manager**.
...
```txt
GET    /api/quote_to_job_conversion_module
POST   /api/quote_to_job_conversion_module
GET    /api/quote_to_job_conversion_module/:id
PATCH  /api/quote_to_job_conversion_module/:id
DELETE /api/quote_to_job_conversion_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/quote_to_job_conversion_module
```
...
```txt
QUOTE_TO_JOB_CONVERSION_MODULE_VIEWED
QUOTE_TO_JOB_CONVERSION_MODULE_CREATED
QUOTE_TO_JOB_CONVERSION_MODULE_UPDATED
QUOTE_TO_JOB_CONVERSION_MODULE_DELETED
QUOTE_TO_JOB_CONVERSION_MODULE_ACCESS_DENIED
QUOTE_TO_JOB_CONVERSION_MODULE_EXPORTED
```
