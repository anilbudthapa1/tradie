# 79. Accountant Export Module — Full Module Specification

## Main Purpose
The **Accountant Export Module** is responsible for accountant-ready CSV/PDF/data export in **Tradie Job Manager**.
...
```txt
GET    /api/accountant_export_module
POST   /api/accountant_export_module
GET    /api/accountant_export_module/:id
PATCH  /api/accountant_export_module/:id
DELETE /api/accountant_export_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/accountant_export_module
```
...
```txt
ACCOUNTANT_EXPORT_MODULE_VIEWED
ACCOUNTANT_EXPORT_MODULE_CREATED
ACCOUNTANT_EXPORT_MODULE_UPDATED
ACCOUNTANT_EXPORT_MODULE_DELETED
ACCOUNTANT_EXPORT_MODULE_ACCESS_DENIED
ACCOUNTANT_EXPORT_MODULE_EXPORTED
```
