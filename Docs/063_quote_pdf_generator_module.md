# 63. Quote PDF Generator Module — Full Module Specification

## Main Purpose
The **Quote PDF Generator Module** is responsible for generate branded quote PDFs in **Tradie Job Manager**.
...
```txt
GET    /api/quote_pdf_generator_module
POST   /api/quote_pdf_generator_module
GET    /api/quote_pdf_generator_module/:id
PATCH  /api/quote_pdf_generator_module/:id
DELETE /api/quote_pdf_generator_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/quote_pdf_generator_module
```
...
```txt
QUOTE_PDF_GENERATOR_MODULE_VIEWED
QUOTE_PDF_GENERATOR_MODULE_CREATED
QUOTE_PDF_GENERATOR_MODULE_UPDATED
QUOTE_PDF_GENERATOR_MODULE_DELETED
QUOTE_PDF_GENERATOR_MODULE_ACCESS_DENIED
QUOTE_PDF_GENERATOR_MODULE_EXPORTED
```
