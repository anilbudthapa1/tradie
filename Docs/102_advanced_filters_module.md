# 102. Advanced Filters Module — Full Module Specification

## Main Purpose
The **Advanced Filters Module** is responsible for saved filters and advanced table filtering in **Tradie Job Manager**.
...
```txt
GET    /api/advanced_filters_module
POST   /api/advanced_filters_module
GET    /api/advanced_filters_module/:id
PATCH  /api/advanced_filters_module/:id
DELETE /api/advanced_filters_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/advanced_filters_module
```
...
```txt
ADVANCED_FILTERS_MODULE_VIEWED
ADVANCED_FILTERS_MODULE_CREATED
ADVANCED_FILTERS_MODULE_UPDATED
ADVANCED_FILTERS_MODULE_DELETED
ADVANCED_FILTERS_MODULE_ACCESS_DENIED
ADVANCED_FILTERS_MODULE_EXPORTED
```
