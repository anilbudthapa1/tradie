# 108. Session Management Module — Full Module Specification

## Main Purpose
The **Session Management Module** is responsible for active sessions and revocation in **Tradie Job Manager**.
...
```txt
GET    /api/session_management_module
POST   /api/session_management_module
GET    /api/session_management_module/:id
PATCH  /api/session_management_module/:id
DELETE /api/session_management_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/session_management_module
```
...
```txt
SESSION_MANAGEMENT_MODULE_VIEWED
SESSION_MANAGEMENT_MODULE_CREATED
SESSION_MANAGEMENT_MODULE_UPDATED
SESSION_MANAGEMENT_MODULE_DELETED
SESSION_MANAGEMENT_MODULE_ACCESS_DENIED
SESSION_MANAGEMENT_MODULE_EXPORTED
```
