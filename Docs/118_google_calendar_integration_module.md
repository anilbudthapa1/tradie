# 118. Google Calendar Integration Module — Full Module Specification

## Main Purpose
The **Google Calendar Integration Module** is responsible for sync jobs to calendars in **Tradie Job Manager**.
...
```txt
GET    /api/google_calendar_integration_module
POST   /api/google_calendar_integration_module
GET    /api/google_calendar_integration_module/:id
PATCH  /api/google_calendar_integration_module/:id
DELETE /api/google_calendar_integration_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/google_calendar_integration_module
```
...
```txt
GOOGLE_CALENDAR_INTEGRATION_MODULE_VIEWED
GOOGLE_CALENDAR_INTEGRATION_MODULE_CREATED
GOOGLE_CALENDAR_INTEGRATION_MODULE_UPDATED
GOOGLE_CALENDAR_INTEGRATION_MODULE_DELETED
GOOGLE_CALENDAR_INTEGRATION_MODULE_ACCESS_DENIED
GOOGLE_CALENDAR_INTEGRATION_MODULE_EXPORTED
```
