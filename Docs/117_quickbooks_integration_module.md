# 117. QuickBooks Integration Module — Full Module Specification

## Main Purpose
The **QuickBooks Integration Module** is responsible for sync finance data to QuickBooks later in **Tradie Job Manager**.
...
```txt
GET    /api/quickbooks_integration_module
POST   /api/quickbooks_integration_module
GET    /api/quickbooks_integration_module/:id
PATCH  /api/quickbooks_integration_module/:id
DELETE /api/quickbooks_integration_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/quickbooks_integration_module
```
...
```txt
QUICKBOOKS_INTEGRATION_MODULE_VIEWED
QUICKBOOKS_INTEGRATION_MODULE_CREATED
QUICKBOOKS_INTEGRATION_MODULE_UPDATED
QUICKBOOKS_INTEGRATION_MODULE_DELETED
QUICKBOOKS_INTEGRATION_MODULE_ACCESS_DENIED
QUICKBOOKS_INTEGRATION_MODULE_EXPORTED
```
