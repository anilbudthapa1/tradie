# 91. Customer ETA Message Module — Full Module Specification

## Main Purpose
The **Customer ETA Message Module** is responsible for send customer ETA/on-the-way updates in **Tradie Job Manager**.
...
```txt
GET    /api/customer_eta_message_module
POST   /api/customer_eta_message_module
GET    /api/customer_eta_message_module/:id
PATCH  /api/customer_eta_message_module/:id
DELETE /api/customer_eta_message_module/:id
```

For employee/self-service views, use explicit safe endpoints:

```txt
GET /api/me/customer_eta_message_module
```
...
```txt
CUSTOMER_ETA_MESSAGE_MODULE_VIEWED
CUSTOMER_ETA_MESSAGE_MODULE_CREATED
CUSTOMER_ETA_MESSAGE_MODULE_UPDATED
CUSTOMER_ETA_MESSAGE_MODULE_DELETED
CUSTOMER_ETA_MESSAGE_MODULE_ACCESS_DENIED
CUSTOMER_ETA_MESSAGE_MODULE_EXPORTED
```
